...
<body class="{{ $theme == 'light' ? 'dark bg-gray-900 text-gray-100' : 'light bg-gray-100 text-gray-700' }}">
    <div class="flex min-h-screen">
        ...
        <div class="flex-grow" style="{{ $theme == 'light' ? 'background-color: #17181C;' : 'background-color: #eeeeee;' }}">
            ...
            <div class="px-8 pt-5 flex justify-center items-center {{ $theme == 'light' ? 'bg-gray-800' : 'bg-gray-300' }}"
            style="{{ $theme == 'light' ? 'background-color: #17181C;' : 'background-color: #eeeeee;' }}">
                <div class="grid grid-cols-12 w-full gap-14">

                    <!-- Box Status Akademik -->
                    <div class="col-span-8 rounded-lg flex flex-col {{ $theme == 'light' ? 'bg-gray-700' : 'bg-gray-200' }}" style="{{ $theme == 'light' ? 'background-color: #17181C;' : 'background-color: #eeeeee;' }}">
                        <h2 class="text-center text-lg font-bold mb-4 ">Status Akademik</h2>

                        <!-- Box Utama Status Akademik -->
                        <div class="grid grid-cols-12 w-full rounded-3xl flex-grow outline outline-1" style="box-shadow: 0 6px 1px 1px rgba(0, 0, 0, 2.5); {{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #ffffff;' }} {{ $theme == 'light' ? 'outline: 1px solid #000000;' : 'outline: 1px solid #000000;' }}">
                    ...
                    <div class="col-span-4 rounded-lg flex flex-col {{ $theme == 'light' ? 'bg-gray-700' : 'bg-gray-200' }}" style="{{ $theme == 'light' ? 'background-color: #17181C;' : 'background-color: #eeeeee;' }}">
                        <h2 class="text-center text-lg font-bold mb-4">Status Departemen</h2>

                        <!-- Box Utama Capaian Akademik -->
                        <div class="rounded-3xl outline outline-1" style="box-shadow: 0 6px 1px 1px rgba(0, 0, 0, 2.5); {{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #EEEEEE;' }} {{ $theme == 'light' ? 'outline: 1px solid #000000;' : 'outline: 1px solid #000000;' }}">
