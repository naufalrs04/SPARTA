    ...
    <table class="table-auto p-5 w-full text-center rounded-lg border-collapse">
        <thead>
            <tr class="bg-[#878A91]">
                ...
                <th class="px-4 py-2 w-1/8 border-r border-white">Hari</th>
                <th class="px-4 py-2 w-1/8 border-r border-white">Jam</th>
                <th class="px-4 py-2 w-1/8 border-r border-white">Ruang</th>
                <th class="px-4 py-2 w-1/8 border-r border-white">Departemen</th>
        ...
        <tbody>
            <tr class="bg-[#2A2C33]">
                ...
                <td class="px-4 py-4 border-r border-white">Senin</td>
                <td class="px-4 py-4 border-r border-white">19.00 - 20.00</td>
                <td class="px-4 py-4 border-r border-white">E101</td>
                <td class="px-4 py-4 border-r border-white">Informatika</td>
                <td class="px-4 py-4 justify-center">
                    <a class="px-4 py-1.5 bg-green-500 text-white rounded-md text-center">Terverifikasi</a>
                </td>
            </tr>
            <tr class="bg-[#2A2C33]">
                ...
                <td class="px-4 py-4 border-r border-white">Selasa</td>
                <td class="px-4 py-4 border-r border-white">07.00 - 09.30</td>
                <td class="px-4 py-4 border-r border-white">E104</td>
                <td class="px-4 py-4 border-r border-white">Informatika</td>
                <td class="px-4 py-4 justify-center">
                    <a class="px-8 py-1.5 bg-red-600 text-white rounded-md text-center">Ditolak</a>
                </td>
            </tr>
            <tr class="bg-[#2A2C33]">
            ...
            <tr class="bg-[#2A2C33]">
                ...
                <td class="px-4 py-4 border-r border-white">Jumat</td>
                <td class="px-4 py-4 border-r border-white">19.00 - 20.00</td>
                <td class="px-4 py-4 border-r border-white">A304</td>
                <td class="px-4 py-4 border-r border-white">Informatika</td>
                <td class="px-4 py-4 justify-center rounded-br-lg">
                    <a class="px-8 py-1.5 bg-red-600 text-white rounded-md text-center inline-block">Ditolak</a>
                </td>
            </tr>
        </tbody>
