...
<body class="{{ $theme == 'light' ? 'text-gray-100' : 'text-gray-800' }}">
    <div class="flex min-h-screen backdrop-blur-sm" style="{{ $theme == 'light' ? 'background-color: #17181C; ' : 'background-color: #eeeeee; ' }}">
        ...
        <div class="flex-grow">
                ...
                <div class="grid grid-cols-12 w-full gap-14">
                    ...
                    <div class="col-span-8 rounded-lg flex flex-col">
                        ...
                        <div class="grid grid-cols-12 w-full rounded-3xl flex-grow outline outline-1 " style="box-shadow: 4px 6px 1px 1px rgba(0, 0, 0, 2.5); {{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #ffffff;' }} {{ $theme == 'light' ? 'outline: 1px solid #000000;' : 'outline: 1px solid #000000;' }}">
                            <div class="col-span-8 p-6 rounded-tl-lg rounded-tl-lg text-lg space-y-5 box-border border-black">
                                <div>
                    ...
                    <div class="col-span-4 rounded-lg flex flex-col">
                        <div class="text-center">
                            <h2 class="text-center text-lg font-semibold mb-4 rounded-lg inline-block px-2 bg-opacity-50 {{ $theme == 'light' ? '' : 'bg-[#ffeeb6]' }}">Status Penjadwalan</h2>
                        </div>
                        ...
                        <div class="rounded-3xl outline outline-1 " style="box-shadow: 4px 6px 1px 1px rgba(0, 0, 0, 2.5); {{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #EEEEEE;' }} {{ $theme == 'light' ? 'outline: 1px solid #000000;' : 'outline: 1px solid #000000;' }}">
                            <div class="p-6 rounded-tl-3xl rounded-tr-3xl text-lg space-y-4 flex-grow flex flex-col items-center justify-center" style="{{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #ffffff;' }}">
                                <div class="text-center w-full mb-3">
                                    <p class="font-bold" style="color: #F0B90B">Mata Kuliah</p>
            ...
            <div class="px-8 py-10 flex justify-center items-center {{ $theme == 'light' ? 'bg-gray-900/50' : 'bg-white-900/50' }}">
                <div class="grid grid-cols-12 w-full">
                    <div class="col-span-12 rounded-lg flex flex-col">
                        <div class="text-center">
                            <h2 class="text-center items-center justify-center text-lg font-semibold mb-4 rounded-lg inline-block px-2 bg-opacity-50 {{ $theme == 'light' ? '' : 'bg-[#ffeeb6]' }}">Status Pengajuan Jadwal Kuliah</h2>
                        </div>

                        {{-- box pengajuan jadwal --}}
                        <div class="grid grid-cols-12 w-full gap-7 p-3 flex-grow rounded-3xl outline outline-1 " style="box-shadow: 4px 6px 1px 1px rgba(0, 0, 0, 2.5); {{ $theme == 'light' ? 'background-color: #2A2C33;' : 'background-color: #ffffff;' }} {{ $theme == 'light' ? 'outline: 1px solid #000000;' : 'outline: 1px solid #000000;' }}"">
                            ...
                            <div class="col-span-12 text-center rounded-2xl p-4 mx-5 mb-5 flex justify-center items-center bg-gradient-to-l from-green-500 via-green-600 to-green-700 {{ $theme == 'light' ? 'text-gray-100' : 'text-gray-100' }}">
                                <p class="text-xl"><strong>TERVERIFIKASI</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
