                ...
                <div class="max-w-xl relative">
                    ...
                    <form id="ruanganForm" method="POST" action="{{ route('simpan.ruangan') }}">
                        ...
                        <button id="dropdownDepartemenButton"
                            class="w-[280px] text-gray-400 p-4 pr-10 pl-4 focus:ring-2 focus:ring-gray-800 rounded-lg bg-[#2A2C33] cursor-pointer border border-transparent hover:border-gray-600 focus:border-gray-600 transition duration-100 ease-in-out flex justify-between items-center">
                        ...
                        <div id="dropdownDepartemen"
                            class="hidden bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 divide-y divide-gray-100 dark:divide-gray-600 rounded-lg shadow w-full absolute z-10 mt-2">
            ...
            <div class="mb-6 mx-3 ">
                        ...
                        <thead>
                            <tr class="bg-gray-700">
                                @foreach ($gedung as $index => $g)
                                    <th
                                        class="px-4 py-2 border-r border-gray-600 {{ $index === 0 ? 'rounded-tl-lg' : '' }} {{ $index === count($gedung) - 1 ? 'rounded-tr-lg' : '' }}">
                                        {{ $g->nama }}
                                    </th>
                                @endforeach
                            </tr>
                ...
                <div class="flex justify-center my-3 mb-3">
                    <input type="number" name="kapasitas" placeholder="Masukkan kapasitas"
                        class="border rounded p-2 text-gray-400 p-4 pr-10 pl-4 focus:ring-2 focus:ring-gray-800 rounded-lg bg-[#2A2C33] cursor-pointer border border-transparent hover:border-gray-600 focus:border-gray-600 transition duration-100 ease-in-out flex justify-between items-center" />
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-center rounded-lg">
                        ...
                        <tbody id="ringkasanBody">
                            <tr>
                                <td colspan="3" class="text-gray-500">Silakan pilih ruangan untuk melihat ringkasan.
                                </td>
                            </tr>
                        </tbody>
                    </table>
